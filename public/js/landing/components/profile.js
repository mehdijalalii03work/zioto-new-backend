    ...
    <div class="bg-[#1A1D23] rounded-2xl p-6 border border-zioto-gold/20 mb-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <input type="text" class="form-input" value="${STATE.userData.first_name || ''}">
        </div>
        <div>
          <label class="form-label">نام خانوادگی</label>
          <input type="text" class="form-input" value="${STATE.userData.last_name || ''}">
        </div>
        <div>
          <label class="form-label">شماره موبایل</label>
          <input type="tel" class="form-input" value="${STATE.userData.phone || ''}" dir="ltr">
        </div>
        <div>
        ...
        <div>
          ...
          <input type="text" class="form-input" value="${STATE.userData.birthDate || ''}" dir="ltr">
        </div>
      </div>
