...
<body class="bg-[#111318] font-vazir text-white min-h-screen">
    ...
    <div class="container mx-auto px-4 py-4 flex items-center justify-between">
      <div class="flex items-center gap-8">
        <a href="/" onclick="navigateTo('home'); return false;">
          <img src="{{ asset('images/zioto-logo.png') }}" alt="ZIOTO" class="h-9">
        </a>
  ...
  <footer class="bg-[#0D0F13] border-t border-zioto-gold/20 mt-20">
    <div class="container mx-auto px-4 py-12">
      <div class="grid grid-cols-1 md:grid-cols-[1fr_1fr_2fr_1fr] gap-8">
        <div>
          <div class="mb-4">
            <span class="text-zioto-gold text-xl font-bold">زیوتو</span>
          </div>
          <p cیlass="text-zioto-gold/80 text-sm mb-3 italic">زیربنای ثروت و سرمایه تو</p>
        ...
        <div>
          ...
          <ul class="space-y-2 text-sm text-white/80">
            ...
            <li class="flex items-center gap-4 text-xs">
