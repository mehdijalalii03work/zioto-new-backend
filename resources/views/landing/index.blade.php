...
<body class="bg-[#111318] font-vazir text-white min-h-screen">
  ...
  <header id="main-header" class="fixed top-0 left-0 right-0 z-50 transition-all duration-300">
    <div class="container mx-auto px-4 py-3 flex items-center justify-between">
      <div class="flex items-center gap-3">
        <a href="/" onclick="navigateTo('home'); return false;">
          <img src="{{ asset('images/zioto-logo.png') }}" alt="ZIOTO" class="h-8">
        </a>
      </div>
      ...
      <div class="flex items-center gap-4">
        <button onclick="navigateTo('cart')" class="relative p-2 text-white/80 hover:text-zioto-gold transition-colors">
          ...
          <span id="cart-count" class="absolute -top-1 -right-1 bg-zioto-gold text-[#111318] text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center hidden">0</span>
        </button>
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-[#111318]/95 backdrop-blur-sm border-t border-white/10">
